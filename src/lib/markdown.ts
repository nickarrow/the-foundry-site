...
function getCalloutIconSvg(type: string): string {
  ...
  const icons: Record<string, string> = {
    ...
    danger:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>',
    example:
    ...
    impacts:
      '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-circle-alert"><circle cx="12" cy="12" r="10"></circle><line x1="12" x2="12" y1="8" y2="12"></line><line x1="12" x2="12.01" y1="16" y2="16"></line></svg>',
    legacies:
...
function remarkIronVault(options: { allFiles: ContentFile[]; baseUrl: string }) {
  ...
  return (tree: unknown) => {
    visit(
      tree,
      (
        node: { type: string; value?: string; lang?: string },
